...
function widget:GetInfo()
	return {
		name      = "Modding_TooltipOverride",  -- Original Chili Selections & CursorTip v2
		desc      = "Modding_TooltipOverride",
		author    = "PetTurtle", -- (GoogleFrog, CarRepairer and jK orginal)
		date      = "2020",
...
local function Modding_TooltipOverride()
...
function widget:Initialize()
	...
	WG.Modding_TooltipOverride = Modding_TooltipOverride
end