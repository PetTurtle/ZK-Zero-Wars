...
local buildings = {
    Left = {
        {unitName = "nexus", x = 2496, z = 1530, dir = "e", endGame = true, notBlocking = false},
        {unitName = "nexusturret", x = 3264, z = 1530, dir = "e", killReward = 800, notBlocking = false},
    ...
    Right = {
        {unitName = "nexus", x = 5696, z = 1530, dir = "w", endGame = true, notBlocking = false},
        {unitName = "nexusturret", x = 4930, z = 1530, dir = "w", killReward = 800, notBlocking = false},
