...
function jumping(jumpPercent) end

function preJump(turn, distance) end

function beginJump() StartThread(ShotScript) end

function halfJump() end
...
function script.StartMoving() StartThread(WalkThread) end
...
function script.QueryWeapon() return fire end
