...
local function onStart()
    sides[1]:onStart(Layout[1].buildings, Layout[1].playerUnits, Layout[1].customParams)
    sides[2]:onStart(Layout[2].buildings, Layout[2].playerUnits, Layout[2].customParams)
